...
const
   ...
   cstSSExtraSystemsMapping: array[0..74] of record
      name: string;
      id  : Integer;
   end = (
      ( name: '3ds';           id: 17  ),
      ( name: 'actionmax';     id: 81  ),
      ( name: 'adam';          id: 89  ),
      ( name: 'advision';      id: 78  ),
      ( name: 'amiga4000';     id: 64  ),
      ( name: 'amiga500';      id: 64  ),
      ( name: 'arcadia';       id: 94  ),
      ( name: 'astrocade';     id: 44  ),
      ( name: 'atom';          id: 36  ),
      ( name: 'c128';          id: 66  ),
      ( name: 'c20';           id: 73  ),
      ( name: 'camplynx';      id: 88  ),
      ( name: 'cave';          id: 75  ),
      ( name: 'cavestory';     id: 135 ),
      ( name: 'coco';          id: 144 ),
      ( name: 'cplus4';        id: 99  ),
      ( name: 'cps1';          id: 6   ),
      ( name: 'cps2';          id: 7   ),
      ( name: 'cps3';          id: 8   ),
      ( name: 'crvision';      id: 241 ),
      ( name: 'dos';           id: 135 ),
      ( name: 'dragon32';      id: 91  ),
      ( name: 'electron';      id: 85  ),
      ( name: 'fmtowns';       id: 253 ),
      ( name: 'fpinball';      id: 199 ),
      ( name: 'gaelco';        id: 194 ),
      ( name: 'gamate';        id: 266 ),
      ( name: 'gameandwatch';  id: 52  ),
      ( name: 'gamecom';       id: 121 ),
      ( name: 'gamecube';      id: 13  ),
      ( name: 'gamepock';      id: 95  ),
      ( name: 'gb2players';    id: 9   ),
      ( name: 'gba2players';   id: 12  ),
      ( name: 'gbc2players';   id: 10  ),
      ( name: 'gmaster';       id: 103 ),
      ( name: 'hbmame';        id: 75  ),
      ( name: 'hikaru';        id: 258 ),
      ( name: 'j2me';          id: 302 ),
      ( name: 'jaguarcd';      id: 171 ),
      ( name: 'lcdgames';      id: 75  ),
      ( name: 'megacd';        id: 20  ),
      ( name: 'megadrive-msu'; id: 1   ),
      ( name: 'model2';        id: 54  ),
      ( name: 'msx2+';         id: 117 ),
      ( name: 'multivision';   id: 109 ),
      ( name: 'n64dd';         id: 122 ),
      ( name: 'ngage';         id: 30  ),
      ( name: 'odyssey2';      id: 104 ),
      ( name: 'oricatmos';     id: 131 ),
      ( name: 'pegasus';       id: 83  ),
      ( name: 'pet';           id: 240 ),
      ( name: 'pinballfx';     id: 143 ),
      ( name: 'pinballfx2';    id: 143 ),
      ( name: 'pinballfx3';    id: 201 ),
      ( name: 'prboom';        id: 135 ),
      ( name: 'ps4';           id: 60  ),
      ( name: 'psvita';        id: 62  ),
      ( name: 'pv1000';        id: 74  ),
      ( name: 'segastv';       id: 69  ),
      ( name: 'sgb';           id: 127 ),
      ( name: 'sgb-msu1';      id: 127 ),
      ( name: 'snes-msu1';     id: 210 ),
      ( name: 'supracan';      id: 100 ),
      ( name: 'switch';        id: 225 ),
      ( name: 'teknoparrot';   id: 269 ),
      ( name: 'thomson';       id: 141 ),
      ( name: 'ti99';          id: 205 ),
      ( name: 'tutor';         id: 317 ),
      ( name: 'vc4000';        id: 281 ),
      ( name: 'vpinball';      id: 198 ),
      ( name: 'windows';       id: 138 ),
      ( name: 'wswan';         id: 45  ),
      ( name: 'wswanc';        id: 46  ),
      ( name: 'xbox360';       id: 33  ),
